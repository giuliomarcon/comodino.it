...
<t:genericpage>
    ...
    <jsp:attribute name="pagecss">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/createshop.css" >
    </jsp:attribute>
                ...
                <div class="col-sm-12">
                    ...
                    <fieldset>
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="shop-name">Nome</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="shop-name" id="shop-name" placeholder="Nome Negozio" required>
                            </div>
                        </div>
                        <div class="form-group">
